                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, i) {
                          ...
                          return _TeacherPerformanceCard(
                            teacherId: doc.id, 
...
class _TeacherPerformanceCard extends StatelessWidget {
  ...
  const _TeacherPerformanceCard({required this.teacherId, required this.data, required this.classMap});
  ...
  @override
  Widget build(BuildContext context) {
    final assigned = data['assigned_classes'] as List<dynamic>? ?? (data['class_id'] != null ? [data['class_id']] : []);
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${data['email'] ?? ''} | ${classNames.isEmpty ? 'No Classes' : classNames}', 
