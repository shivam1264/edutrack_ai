...
class CreateAssignmentScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Create Assignment')));
}
...
class CreateQuizScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Create Quiz')));
}
...
class SubmissionListScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: Text(assignment.title)));
}
...
class TeacherQuizzesScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Quizzes')));
}
...
class UploadNotesScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Upload Notes')));
}

class AssignmentAuditScreen extends StatelessWidget {
  const AssignmentAuditScreen({super.key});
  @override
  Widget build(BuildContext context) => Scaffold(appBar: AppBar(title: const Text('Audit')));
}
